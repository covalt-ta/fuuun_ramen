...
管理や業務効率の側面ではIT活用は進みつつありましたが、集客・売上を得られるIT活用こそが最重要課題と感じていました。

実店舗にとって集客・売上を得られるIT活用とは「ECサイトでの売上軸の確立すること」と捉えました。
そしてファーストステップとして、Webサイトへの訪問を日常的に行ってもらう必要があると考えました。

「今現在、店舗に来店されているお客様に、Webサイトへのログインをしてもらう」

これがオンラインでの売上軸の獲得のファーストステップであると考え、架空のラーメン店を想定したモバイルオーダーが可能なアプリケーションWebサイトを作成しました。
